...
<div class="header">
    <div class="home-menu pure-menu pure-menu-open pure-menu-horizontal pure-menu-fixed">
	    ...
	    <li><a href="http://students.iitmandi.ac.in/~v_kumar/BankMan_final/BanKMan/">Lite Edition</a></li>
           <li><a href="http://students.iitmandi.ac.in/~v_kumar/BankMan_final/about/index.html">About us </a></li>
        </ul>
    </div>
</div>
