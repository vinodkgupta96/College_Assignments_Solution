...
<p text-align="right" id="home"><a href="http://students.iitmandi.ac.in/~v_kumar/BankMan_final/home.php">Back to heavier version</a></p>
	<section>
	...
	<form action="<?php echo $current_file;?>" method="POST" onsubmit="return validateForm1()">
		 Employee ID:&nbsp;<input type="text" value="" name="Emp_id" required><br>
		 Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" value="" name="Password" required><br><br>
...
?>
	...
	<form action="<?php echo $current_file;?>" method="POST"  onsubmit="return validateForm()">
 	ATM NUMBER:&nbsp;<input type="text" value="" name="ATM_NO" required><br>
 	PIN:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" value="" name="PIN" required><br><br>
	<input type="submit" value="Sign in">
	</form>
...
if(isset($_POST['ATM_NO']) && !empty($_POST['ATM_NO']) && isset($_POST['PIN']) && !empty($_POST['PIN']) ){
	...
	<footer>
	<h5> Powered by BankMan Systems<br></h5>
	</footer>
